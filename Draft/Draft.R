...
url <- 'http://www.hockeydb.com/ihdb/draft/nhl2016e.html'
...
write.csv(draft.table,"Draft/2016_NHL-Draft.csv", row.names=F)

######################################################################


draft.table <- read.csv("Draft/2016_NHL-Draft.csv",header=T,stringsAsFactors=F)
